...
dict_obj = {
	...
	"it" :
            ...
            "home_you":'Sei tu!',
            "img_interaction_text":"<b>Esempio di interazione:</b> Il speaker sceglie un oggetto, poi una parola che per lui ci e associata, e il hearer interpreta la parola come un oggetto. Se i due sono i stessi, la communicazione e un successo.",
    ...
    "en" :
            ...
            "img_interaction_text":"<b>Example of an interaction:</b> The speaker chooses an object or meaning, then a word he thinks is associated to it, and finally the hearer interpretes the word as a meaning. If the two meanings are the same, the communication was successful.",
