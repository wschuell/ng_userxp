...
RUN apt-get update && apt-get install --yes --force-yes build-essential python-dev liblzo2-dev liblzma-dev libsqlite3-dev python-tk postgresql postgresql-contrib libpq-dev
